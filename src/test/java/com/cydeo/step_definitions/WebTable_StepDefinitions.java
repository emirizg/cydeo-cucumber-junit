...
public class WebTable_StepDefinitions {
    ...
    @When("user enters usernme {string}")
    public void user_enters_usernme(String string) {
    ...
    public void user_enters_usernme_and_password_and_logins(String username, String password) {
